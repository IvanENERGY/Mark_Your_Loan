...
2. Error fixing on <i>/mnt/c/Users/Sunday/AppData/Roaming/npm/node_modules/eas-cli/node_modules/@oclif/core/lib/command.js:41
delete this.globalFlags?.json; This error can be solved by updating nodejs</i>
...
3. install everything  latest (dont forget adding <code> sudo </code>infront)
...
4.Remove all node modules download in window (window should ask for permission by popup), do npm install using ubuntu, 


5.<code>eas build --platform android --local --profile dev</code>
</ol>