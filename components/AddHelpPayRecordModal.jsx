    ...
    const onSubmitHandler=()=>{
        ...
        if(validateForm()){
            (async()=>{
                try{
                    const db =await SQLite.openDatabaseAsync('example.db');
                    result= await db.runAsync('INSERT INTO helpPays (amount,comment,linkedFriendId) VALUES (?,?,?)',amount,comments,selectedFdId);  
                    console.log('insert helpPays',result);
                ...
                <View style={styles.mainContainer}> 
                    ...
                    <Image source={require("../assets/img/helpPay.png")} style={styles.icon} resizeMode="contain"/>
                        ...
                        >
                            ...
                            {/* <Picker.Item label="Ivan" value="Ivan" />
